...
Full decoder ring — checked when CLAUDE.md hot cache doesn't have a term.

## People
| Name/nickname | Full identity |
|---|---|
| | |
...
| Term | Meaning |
|---|---|
| IDC | PADI Instructor Development Course — Eduardo is a Staff Instructor level scuba cert |
